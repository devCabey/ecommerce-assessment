  ...
  return (
    <>
      <div className='flex items-center justify-start m-5'>
        <Link
          to='/products'
          className='flex items-center justify-start text-xs cursor-pointer m-5 font-bold'>
          {' '}
          {'<< Back To Products'}
        </Link>
      </div>
      {loading ? (
        ...
        <div className='w-full flex justify-between p-20 gap-10 '>
          ...
          <div className='w-1/2 '>
            <div className=''>
              <h1 className='text-3xl font-medium'>{data.getProduct.name}</h1>
